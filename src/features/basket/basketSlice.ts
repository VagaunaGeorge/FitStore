...
export const basketSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addMatcher(isAnyOf(addBasketItemsAsync.fulfilled, fetchBasketAsync.fulfilled), (state, action) => {
      state.basket = action.payload;
      state.status = 'idle';
    });
    builder.addMatcher(isAnyOf(addBasketItemsAsync.rejected, fetchBasketAsync.rejected), (state, action)  => {
      console.log(action.payload);
      state.status = 'idle';
    });
  },
